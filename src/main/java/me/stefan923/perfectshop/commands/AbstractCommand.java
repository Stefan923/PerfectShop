...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(PerfectShop instance, CommandSender sender, String... args) throws MissingPermissionException;

    protected abstract List<String> onTab(PerfectShop instance, CommandSender sender, String... args);
